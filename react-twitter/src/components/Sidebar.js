    ...
    <div className="h-full sm:flex-row w-96 bg-black text-white fixed border-gray-800" id='sidebar'>
      <ul className="space-y-2 mr-5">
        ...
        <li className='flex'>
          <NavLink
            to="/premium"
            className=" hidden 2xl:block  items-center justify-start ml-40 p-2 space-x-3 hover:bg-gray-700">
            <svg className='w-6 flex h-6 fill-current text-white'>
                <path d='M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z'/>
            </svg>
        ...
        <li className="flex items-center justify-start ml-40 p-2 space-x-3 hover:bg-gray-700">
          <button className="hidden 2xl:block items-center justify-center">
            <svg className='w-6 h-6 fill-current text-white'>
