...
const Header = () => {
  return (
    ...
    <div className="h-full w-96 bg-black text-white fixed">
      <ul className="space-y-2 mr-5">
        ...
        <NavLink
            to="/"
            className="flex items-center justify-center p-4 space-x-3 hover:bg-gray-700">
            <svg className='w-6 h-6 fill-current text-white'>
        ...
        <li>
            <button className="flex items-center justify-center p-4 space-x-3 hover:bg-gray-700">
                <svg className='w-6 h-6 fill-current text-white'>
