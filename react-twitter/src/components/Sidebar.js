...
const Header = () => {
  return (
    <div>
    <div className="h-full w-96 bg-black text-white fixed border-gray-800">
      <ul className="space-y-2 mr-5 border-gray-800">
        ...
        <NavLink
            to="/"
            className="flex items-center justify-center p-2 space-x-3 hover:bg-gray-700">
            <svg className='w-6 h-6 fill-current text-white'>
        ...
        <li>
          <NavLink
            ...
            <p className="text-white font-semibold text-xl">Grok</p>
          </NavLink>
        </li>
        <li>
          <NavLink
            ...
            <p className="text-white font-semibold text-xl">Communities</p>
          </NavLink>
        </li>
        <li>
          <NavLink
        ...
        <li>
          <NavLink
            ...
            <p className="text-white font-semibold text-xl">Busines</p>
          </NavLink>
        </li>
        <li>
          <NavLink
        ...
        <li className="flex items-center justify-center p-2 space-x-3 hover:bg-gray-700">
          <button className="flex items-center justify-center">
            <svg className='w-6 h-6 fill-current text-white'>
            <path d='M3.75 12c0-4.56 3.69-8.25 8.25-8.25s8.25 3.69 8.25 8.25-3.69 8.25-8.25 8.25S3.75 16.56 3.75 12zM12 1.75C6.34 1.75 1.75 6.34 1.75 12S6.34 22.25 12 22.25 22.25 17.66 22.25 12 17.66 1.75 12 1.75zm-4.75 11.5c.69 0 1.25-.56 1.25-1.25s-.56-1.25-1.25-1.25S6 11.31 6 12s.56 1.25 1.25 1.25zm9.5 0c.69 0 1.25-.56 1.25-1.25s-.56-1.25-1.25-1.25-1.25.56-1.25 1.25.56 1.25 1.25 1.25zM13.25 12c0 .69-.56 1.25-1.25 1.25s-1.25-.56-1.25-1.25.56-1.25 1.25-1.25 1.25.56 1.25 1.25z'/>
            </svg>
            <p className="text-white font-semibold text-xl">More</p>
          </button>
        </li>
        <li className="flex items-center justify-center p-2 space-x-3 hover:bg-gray-700">
          <button className="flex items-center justify-center rounded-full w-60 h-12" id='post'>
