  ...
  return (
    ...
    <div className="h-full w-96 bg-black text-white fixed">
      <ul className="space-y-2">
        ...
        <NavLink
            to="/home"
            className="flex items-center p-4 space-x-3 hover:bg-gray-700">
            <svg className='w-6 h-6 fill-current text-white'>
        ...
        <li>
          <NavLink
            ...
            <p className="text-white text-sm">Grok</p>
          </NavLink>
        </li>
        <li>
          <NavLink
            ...
            <p className="text-white text-sm">Communities</p>
          </NavLink>
        </li>
        <li>
          <NavLink
        ...
        <li>
          <NavLink
            ...
            <p className="text-white text-sm">Busines</p>
          </NavLink>
        </li>
        <li>
          <NavLink
